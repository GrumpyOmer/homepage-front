...
export default function Three() {
  ...
  return (
    <div className={styles.three}>
      ...
      <div className={styles.box}>
        <p>
          毕竟我也是一名码农，码农的职业病在当今这个内卷盛世下尤为常见：尿酸高、虚胖、脂肪肝。。。归根究底还是由于工作的时间过于饱和，特别是在一线城市为了工作大部分人日常都是早出晚归，长时间的精神压抑和得不到锻炼所导致的。庆幸的是我早几年就已经意识到了这点，晚上加班后回到家哪怕已经10点只要有精力就会去夜跑个几公里。
        </p>
      </div>
      {Img([img2])}
      <div className={styles.box}>
        ...
        <p>接下来半年努力健身吧，人一长胖果然就会失去自律，要做个自律的人。</p>
      </div>
    </div>
  );
}
